                        ...
                        <div class="border-b border-gray-200 pb-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <input type="text" name="pis_pasep" id="pis_pasep" value="{{ old('pis_pasep') }}"
                        ...
                        <div class="border-b border-gray-200 pb-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <input type="number" name="weekly_hours" id="weekly_hours" value="{{ old('weekly_hours', 44) }}" required min="1" max="44"
                                ...
                                <div>
                                    ...
                                    <input type="number" name="meal_break_minutes" id="meal_break_minutes" value="{{ old('meal_break_minutes', 60) }}" required min="30" max="120"
                                ...
                                <div class="flex items-center space-x-6">
                                    <div class="flex items-center">
                                        <input type="checkbox" name="exempt_time_control" id="exempt_time_control" value="1" {{ old('exempt_time_control') ? 'checked' : '' }}
                                    ...
                                    <div class="flex items-center">
                                        <input type="checkbox" name="has_meal_break" id="has_meal_break" value="1" {{ old('has_meal_break', true) ? 'checked' : '' }}
                                               class="h-4 w-4 text-indigo-600 focus:ring-indigo-500 border-gray-300 rounded">
