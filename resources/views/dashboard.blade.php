    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            @if(auth()->user()->isSupervisor() || auth()->user()->isHR() || auth()->user()->isAdmin())
                <!-- Cards para Supervisores ou acima -->
            ...
            @else
                <!-- Cards simplificados para Funcionários comuns -->
                    ...
                    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                        <div class="p-6">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4">
                                    <p class="text-sm font-medium text-gray-500">Status Hoje</p>
                                    <p class="text-2xl font-semibold text-gray-900">
                                        {{ $presentEmployees > 0 ? 'Presente' : 'Ausente' }}
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                        <div class="p-6">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4">
                                    <p class="text-sm font-medium text-gray-500">Meus Registros Hoje</p>
                                    <p class="text-2xl font-semibold text-gray-900">{{ $todayRecords }}</p>
                                </div>
                            </div>
                        </div>
            ...
            @if(auth()->user()->isSupervisor() || auth()->user()->isHR() || auth()->user()->isAdmin())
                <!-- Seções completas para Supervisores ou acima -->
                ...
                @else
                    <!-- Seção simplificada para Funcionários comuns -->
                    <div class="grid grid-cols-1 gap-8">
                        <!-- Meus Últimos Registros -->
                        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                            <div class="p-6">
                                <h3 class="text-lg font-medium text-gray-900 mb-4">Meus Últimos Registros</h3>
                                <div class="space-y-3">
                                    @forelse($recentTimeRecords as $record)
                                        <div class="flex items-center justify-between py-2 border-b border-gray-200">
                                            <div>
