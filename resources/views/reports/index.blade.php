    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg hover:shadow-md transition-shadow">
                    <div class="p-6">
                        ...
                        <p class="text-gray-600 text-sm mb-4">
                            Relatório detalhado de todos os registros de ponto com filtros por funcionário, período e tipo
                            de marcação.
                        </p>
                ...
                <div
                    class="bg-gradient-to-r from-purple-500 to-pink-500 overflow-hidden shadow-sm sm:rounded-lg text-white">
                    <div class="p-6">
                        <div class="flex items-center mb-4">
                            <div class="flex-shrink-0">
                        ...
                        <div class="space-y-2 text-sm">
                            <div class="flex justify-between">
                                ...
                                <span
                                    class="font-semibold">{{ \App\Models\TimeRecord::whereDate('record_date', today())->count() }}</span>
                            </div>
                            <div class="flex justify-between">
                            ...
                            <div class="flex justify-between">
                                ...
                                <span
                                    class="font-semibold">{{ \App\Models\Absence::pending()->count() + \App\Models\Overtime::pending()->count() }}</span>
                            </div>
                        </div>
                    </div>
                </div>
