                                        ...
                                        <div class="border border-gray-200 rounded-lg p-4">
                                            <div class="flex items-center justify-between">
                                                ...
                                                <div class="text-right">
                                                    <p class="text-sm font-medium text-gray-900">{{ $child->employees->count() }}</p>
                        ...
                        <div class="p-6">
                            ...
                            <div class="space-y-4">
                                ...
                                <div class="flex justify-between">
                                    ...
                                    <span class="text-sm font-medium text-gray-900">{{ $department->employees->where('active', true)->count() }}</span>
                                </div>
                                <div class="flex justify-between">
                                    <span class="text-sm text-gray-600">Subdepartamentos:</span>
                                    <span class="text-sm font-medium text-gray-900">{{ $department->childDepartments->count() }}</span>
                                </div>
                            </div>
                        </div>
                    </div>
