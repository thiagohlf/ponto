    ...
    <x-slot name="header">
        <div class="flex justify-between items-center">
            ...
            <div class="flex space-x-2">
                <a href="{{ route('departments.show', $department) }}" class="bg-gray-500 hover:bg-gray-700 text-white font-bold py-2 px-4 rounded">
                    Ver Detalhes
                </a>
                    ...
                    <form method="POST" action="{{ route('departments.update', $department) }}" class="space-y-6">
                        ...
                        <div class="border-b border-gray-200 pb-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    <label for="parent_department_id" class="block text-sm font-medium text-gray-700">Departamento Superior</label>
                                    <select name="parent_department_id" id="parent_department_id" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 @error('parent_department_id') border-red-300 @enderror">
                                ...
                                <div>
                                    ...
                                    <input type="text" name="cost_center" id="cost_center" value="{{ old('cost_center', $department->cost_center) }}"
                                           placeholder="Ex: CC001, 1001..."
                                ...
                                <div class="md:col-span-2">
                                    ...
                                    <textarea name="description" id="description" rows="3" 
                                              ...
                                              class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 @error('description') border-red-300 @enderror">{{ old('description', $department->description) }}</textarea>
                                    @error('description')
                                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                    @enderror
                                </div>
