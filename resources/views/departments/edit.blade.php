                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                        ...
                                        @foreach ($departments as $dept)
                                            @if ($dept->id !== $department->id)
                                                <option value="{{ $dept->id }}"
                                                    {{ old('parent_department_id', $department->parent_department_id) == $dept->id ? 'selected' : '' }}>
                                ...
                                <div>
                                    ...
                                    <input type="text" name="code" id="code"
                                        value="{{ old('code', $department->code) }}" placeholder="Ex: RH, TI, VND..."
                                ...
                                <div>
                                    ...
                                    <input type="text" name="cost_center" id="cost_center"
                                        value="{{ old('cost_center', $department->cost_center) }}"
