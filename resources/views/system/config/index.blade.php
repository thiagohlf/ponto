                                ...
                                @if(auth()->user()->isAdmin())
                                    ...
                                    <div class="mb-4 p-3 bg-green-50 border border-green-200 rounded-lg">
                                        <p class="text-xs text-green-700">
                                            ...
                                            ✅ Pode configurar: {{ auth()->user()->can('configurar_sistema') ? 'SIM' : 'NÃO' }}
                                        </p>
                                    </div>
                                                ...
                                                <div class="w-full">
                                                    ...
                                                    <div class="bg-blue-100 p-3 rounded-md mb-4">
                                                        <div class="grid grid-cols-2 gap-4 text-xs text-blue-800">
                                                            <div>
                                                                <strong>Banco:</strong> {{ config('database.connections.mysql.database') }}
                                                            </div>
                                                            <div>
                                                                <strong>Host:</strong> {{ config('database.connections.mysql.host') }}:{{ config('database.connections.mysql.port') }}
                                                            </div>
                                                            <div>
                                                                <strong>Método:</strong> <span id="backup-method">PHP/PDO (mysqldump não disponível)</span>
                                                            </div>
                                                            <div>
                                                    ...
                                                    <div class="flex space-x-3">
                                                        <form method="POST" action="{{ route('system.backup.create') }}" class="inline" id="backup-form">
                                                            @csrf
                                                            <button type="submit" 
                                                                    id="backup-button"
                                                                ...
                                                                <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" id="backup-icon">
                                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 16a4 4 0 01-.88-7.903A5 5 0 1115.9 6L16 6a5 5 0 011 9.9M9 19l3 3m0 0l3-3m-3 3V10"></path>
                                                                </svg>
                                                    ...
                                                    <div id="backup-progress" class="hidden mt-4">
                                                        ...
                                                        <p class="text-xs text-blue-700 mt-1" id="progress-text">Iniciando backup...</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="pt-4 border-t border-gray-200">
                                        <div class="bg-red-50 p-4 rounded-lg">
                                            <p class="text-sm text-red-700">
                                                ❌ Backup não disponível - Usuário: {{ auth()->user()->name }} não é administrador
                                            </p>
                                        </div>
                                    </div>
                                @endif
