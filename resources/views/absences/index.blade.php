                    ...
                    <form method="GET" action="{{ route('absences.index') }}" class="grid grid-cols-1 md:grid-cols-5 gap-4">
                        ...
                        <div>
                            ...
                            <select name="absence_type" id="absence_type"
                                ...
                                <option value="sick_leave" {{ request('absence_type') == 'sick_leave' ? 'selected' : '' }}>
                                    Atestado Médico</option>
                                <option value="vacation" {{ request('absence_type') == 'vacation' ? 'selected' : '' }}>
                                    Férias</option>
                                <option value="maternity_leave"
                                    {{ request('absence_type') == 'maternity_leave' ? 'selected' : '' }}>Licença Maternidade
                                </option>
                                <option value="paternity_leave"
                                    {{ request('absence_type') == 'paternity_leave' ? 'selected' : '' }}>Licença Paternidade
                                </option>
                                <option value="bereavement"
                                    {{ request('absence_type') == 'bereavement' ? 'selected' : '' }}>Luto</option>
                                <option value="marriage" {{ request('absence_type') == 'marriage' ? 'selected' : '' }}>
                                    Casamento</option>
                                <option value="unjustified"
                                    {{ request('absence_type') == 'unjustified' ? 'selected' : '' }}>Falta Injustificada
                                </option>
                            </select>
                        </div>
