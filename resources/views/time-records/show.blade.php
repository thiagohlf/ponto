    ...
    <div class="flex justify-between items-center">
        ...
        <div class="flex space-x-2">
            @can('gerenciar_registros_ponto')
                <a href="{{ route('time-records.edit', $timeRecord) }}"
                            ...
                            <div class="ml-3">
                                ...
                                @can('aprovar_registros_ponto')
                                    <div class="mt-4 flex space-x-2">
                                        <form method="POST" action="{{ route('time-records.approve', $timeRecord) }}"
                                            class="inline">
                                            @csrf
                                            @method('PATCH')
                                            <button type="submit"
                        ...
                        <div class="p-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <p class="mt-1 text-sm text-gray-900">{{ $timeRecord->employee->user->name }}</p>
                                    <p class="text-xs text-gray-500">{{ $timeRecord->employee->registration_number }}</p>
                                </div>

                                <div>
                                    <label class="block text-sm font-medium text-gray-700">Data</label>
                                    <p class="mt-1 text-sm text-gray-900">{{ $timeRecord->record_date->format('d/m/Y') }}
                                    </p>
                                ...
                                <div>
                                    ...
                                    <p class="mt-1 text-sm text-gray-900 font-mono text-lg">{{ $timeRecord->record_time }}
                                    </p>
                                </div>
                                ...
                                <div>
                                    ...
                                    <p class="mt-1 text-sm text-gray-900">Sistema Web</p>
                                    <p class="text-xs text-gray-500">Registro via navegador</p>
                                </div>
                                            ...
                                            <div
                                                ...
                                                <div class="flex-shrink-0">
                                                    <a href="{{ route('time-records.attachment.download', [$timeRecord, $attachment['filename']]) }}"
                                                        ...
                                                        <svg class="-ml-0.5 mr-1 h-4 w-4" fill="none"
                            ...
                            <div class="space-y-4">
                                <div>
                                    ...
                                    <p class="mt-1 text-sm text-gray-900">
                                        {{ $timeRecord->created_at->format('d/m/Y H:i:s') }}</p>
                                </div>
                                ...
                                @if ($timeRecord->updated_at != $timeRecord->created_at)
                                    <div>
                                        ...
                                        <p class="mt-1 text-sm text-gray-900">
                                            {{ $timeRecord->updated_at->format('d/m/Y H:i:s') }}</p>
                                    </div>
                                @endif
                                ...
                                @if ($timeRecord->original_datetime)
                                    <div>
                                        ...
                                        <p class="mt-1 text-sm text-gray-900">
                                            {{ $timeRecord->original_datetime->format('d/m/Y H:i:s') }}</p>
                                    </div>
                                @endif
                                ...
                                @if ($timeRecord->changed_by)
                                    <div>
                                        ...
                                        @if ($timeRecord->changed_at)
                                            <p class="text-xs text-gray-500">
                                                {{ $timeRecord->changed_at->format('d/m/Y H:i:s') }}</p>
                                        @endif
                                    </div>
                                @endif
                                ...
                                @if ($timeRecord->hash_verification)
                                    <div>
                                        ...
                                        <p class="mt-1 text-xs text-gray-900 font-mono break-all">
                                            {{ substr($timeRecord->hash_verification, 0, 32) }}...</p>
                                    </div>
                                @endif
                            </div>
                        </div>
