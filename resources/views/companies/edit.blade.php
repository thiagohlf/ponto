                        ...
                        <div class="border-b border-gray-200 pb-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <input type="text" name="cnpj" id="cnpj" value="{{ old('cnpj', $company->cnpj) }}" required
                                ...
                                <div>
                                    ...
                                    <input type="text" name="state_registration" id="state_registration" value="{{ old('state_registration', $company->state_registration) }}"
                                ...
                                <div>
                                    ...
                                    <input type="text" name="municipal_registration" id="municipal_registration" value="{{ old('municipal_registration', $company->municipal_registration) }}"
                        ...
                        <div class="border-b border-gray-200 pb-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <input type="text" name="number" id="number" value="{{ old('number', $company->number) }}" required
                                ...
                                <div>
                                    ...
                                    <select name="state" id="state" required class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 @error('state') border-red-300 @enderror">
                                        ...
                                        <option value="AC" {{ old('state', $company->state) == 'AC' ? 'selected' : '' }}>Acre</option>
                                        <option value="AL" {{ old('state', $company->state) == 'AL' ? 'selected' : '' }}>Alagoas</option>
                                        <option value="AP" {{ old('state', $company->state) == 'AP' ? 'selected' : '' }}>Amapá</option>
                                        <option value="AM" {{ old('state', $company->state) == 'AM' ? 'selected' : '' }}>Amazonas</option>
                                        <option value="BA" {{ old('state', $company->state) == 'BA' ? 'selected' : '' }}>Bahia</option>
                                        <option value="CE" {{ old('state', $company->state) == 'CE' ? 'selected' : '' }}>Ceará</option>
                                        <option value="DF" {{ old('state', $company->state) == 'DF' ? 'selected' : '' }}>Distrito Federal</option>
                                        <option value="ES" {{ old('state', $company->state) == 'ES' ? 'selected' : '' }}>Espírito Santo</option>
                                        <option value="GO" {{ old('state', $company->state) == 'GO' ? 'selected' : '' }}>Goiás</option>
                                        <option value="MA" {{ old('state', $company->state) == 'MA' ? 'selected' : '' }}>Maranhão</option>
                                        <option value="MT" {{ old('state', $company->state) == 'MT' ? 'selected' : '' }}>Mato Grosso</option>
                                        <option value="MS" {{ old('state', $company->state) == 'MS' ? 'selected' : '' }}>Mato Grosso do Sul</option>
                                        <option value="MG" {{ old('state', $company->state) == 'MG' ? 'selected' : '' }}>Minas Gerais</option>
                                        <option value="PA" {{ old('state', $company->state) == 'PA' ? 'selected' : '' }}>Pará</option>
                                        <option value="PB" {{ old('state', $company->state) == 'PB' ? 'selected' : '' }}>Paraíba</option>
                                        <option value="PR" {{ old('state', $company->state) == 'PR' ? 'selected' : '' }}>Paraná</option>
                                        <option value="PE" {{ old('state', $company->state) == 'PE' ? 'selected' : '' }}>Pernambuco</option>
                                        <option value="PI" {{ old('state', $company->state) == 'PI' ? 'selected' : '' }}>Piauí</option>
                                        <option value="RJ" {{ old('state', $company->state) == 'RJ' ? 'selected' : '' }}>Rio de Janeiro</option>
                                        <option value="RN" {{ old('state', $company->state) == 'RN' ? 'selected' : '' }}>Rio Grande do Norte</option>
                                        <option value="RS" {{ old('state', $company->state) == 'RS' ? 'selected' : '' }}>Rio Grande do Sul</option>
                                        <option value="RO" {{ old('state', $company->state) == 'RO' ? 'selected' : '' }}>Rondônia</option>
                                        <option value="RR" {{ old('state', $company->state) == 'RR' ? 'selected' : '' }}>Roraima</option>
                                        <option value="SC" {{ old('state', $company->state) == 'SC' ? 'selected' : '' }}>Santa Catarina</option>
                                        <option value="SP" {{ old('state', $company->state) == 'SP' ? 'selected' : '' }}>São Paulo</option>
                                        <option value="SE" {{ old('state', $company->state) == 'SE' ? 'selected' : '' }}>Sergipe</option>
                                        <option value="TO" {{ old('state', $company->state) == 'TO' ? 'selected' : '' }}>Tocantins</option>
                                    </select>
                                    @error('state')
                                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                    @enderror
                                ...
                                <div>
                                    ...
                                    <input type="text" name="zip_code" id="zip_code" value="{{ old('zip_code', $company->zip_code) }}" required
                        ...
                        <div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <input type="number" name="tolerance_minutes" id="tolerance_minutes" value="{{ old('tolerance_minutes', $company->tolerance_minutes) }}" required min="0" max="60"
                                ...
                                <div class="flex items-center space-x-6">
                                    <div class="flex items-center">
                                        <input type="checkbox" name="requires_justification" id="requires_justification" value="1" {{ old('requires_justification', $company->requires_justification) ? 'checked' : '' }}
